...
const updateRegisteredSemesterInDB = async (
  id: string,
  ...
  if (!doesSemesterRegistrationExist) {
    throw new AppError(
      httpStatus.NOT_FOUND,
      'Requested Semester is not registered !',
    );
  }
  ...
  if (
    currentRegisteredSemesterStatus === RegistrationStatus.UPCOMING &&
  ...
  if (
    currentRegisteredSemesterStatus === RegistrationStatus.ONGOING &&
